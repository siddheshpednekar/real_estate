<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Payment1.aspx.cs" Inherits="clgproj.Payment1" %>
            ...
            <div class="row">
                <div class="col-75">
                    <div class="container">
                        ...
                        <asp:Button ID="Button1" CssClass="btn" runat="server" Text="Continue to Pay" OnClick="Button1_Click" />
                        </div>
                    </div>
                    <div class="col-25">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-50">
                                    ...
                                    <hr /><br />
                                    Amount Paid:<br /> Rs. 
                                    <asp:Label ID="Label7" runat="server" Text=""></asp:Label><br /><hr /><br />
                                    Installments Remaining:<br />
                                ...
                                <div class="col-50">
                                    ...
                                    Floor Number:<br />
                                    <asp:Label ID="Label4" runat="server" Text=""></asp:Label><br /><hr /><br />
                                    
                                    Total Cost:<br /> Rs. 
                                    <asp:Label ID="Label6" runat="server" CssClass="tot" Text=""></asp:Label><br /><hr /><br />
                                    Amount Remaining:<br /> Rs. 
